...
#define STRING_CONFIG_H_AUTHOR "(irex, Ender-5)" // Who made the changes.
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  33.22,  33.22 }
    #define DEFAULT_Ki_LIST {   3.12,   3.12 }
    #define DEFAULT_Kd_LIST { 88.55, 88.55 }
  #else
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -70, -18, -1.380 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT X_MAX_POS - 5 - 70 // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT Y_MAX_POS - 5 - 18 // Y point for Z homing
